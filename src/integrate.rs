...
use crate::{ElectronTrace, Nucleus};

/// Acceleration, based on curvature as a function of position.
fn accel() -> f64 {
    0.
}
...
pub fn integrate_rk4<F>(body: &mut ElectronTrace, id: usize, acc: &F, dt: f64)
where
